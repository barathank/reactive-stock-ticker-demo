  ...
  _highlightChange: function(change) {
      ...
      if (parentNode) {
          ...
          window.requestAnimationFrame(function highlightParentElementBorder(){
              ...
              parentNode.style.transition = 'background-color 0s';
              if (change === self.STATE_CHANGES.MOUNT) {
                  parentNode.style.outline = self.styling.elementHighlightMount.outline;
                  parentNode.style.backgroundColor = self.styling.elementHighlightMount.backgroundColor;
              } else {
                  parentNode.style.outline = self.styling.elementHighlightUpdate.outline;
                  parentNode.style.backgroundColor = self.styling.elementHighlightUpdate.backgroundColor;
              }
              ...
              window.requestAnimationFrame(function animateParentElementBorder() {
                  ...
                  parentNode.style.backgroundColor = self.styling.elementHighlightMonitor.backgroundColor;
                  parentNode.style.transition = 'background-color '+ANIMATION_DURATION+'ms linear';
              });
          });
      }
  }
